...
exports.parseInstanceXML = function(xml) {
  // parse to json
...
exports.parseFormDefXML = function(xmldatalist) {
  return new Promise(function (resolve) {
    ...
    xmldatalist.forEach(function (xmldata) {
      var flatxml = exports.parseInstanceXML(xmldata);
      if (!flatxml) {
        return;
      }
      ...
      flatdefs[formname] = {};
      flatdefs[formname].fields = flatxml.fields;
      // apply version attribute taken from form's eponymous tag
      flatdefs[formname].version = flatxml.jsondata._Attribs.version;
    });
